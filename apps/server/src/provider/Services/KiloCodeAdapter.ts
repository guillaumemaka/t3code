/**
 * KiloCodeAdapter — shape type for the KiloCode provider adapter.
 *
 ...
 * model ({@link ../Drivers/KiloCodeDriver}) bundles one adapter per
...
/**
 * KiloCodeAdapterShape — per-instance KiloCode adapter contract. Carries
